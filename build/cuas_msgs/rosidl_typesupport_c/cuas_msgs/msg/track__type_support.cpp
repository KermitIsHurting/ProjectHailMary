...
static const _Track_type_support_symbol_names_t _Track_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuas_msgs, msg, Track)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuas_msgs, msg, Track)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cuas_msgs, msg, Track)() {
  return &::cuas_msgs::msg::rosidl_typesupport_c::Track_message_type_support_handle;
}
