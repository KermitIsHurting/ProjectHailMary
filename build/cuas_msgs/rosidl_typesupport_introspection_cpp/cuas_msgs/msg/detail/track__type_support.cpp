...
{
  new (message_memory) cuas_msgs::msg::Track(_init);
}

void Track_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cuas_msgs::msg::Track *>(message_memory);
  typed_message->~Track();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Track_message_member_array[1] = {
  {
    ...
    offsetof(cuas_msgs::msg::Track, structure_needs_at_least_one_member),  // bytes offset in struct
...
{
  return &::cuas_msgs::msg::rosidl_typesupport_introspection_cpp::Track_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cuas_msgs, msg, Track)() {
  return &::cuas_msgs::msg::rosidl_typesupport_introspection_cpp::Track_message_type_support_handle;
}
