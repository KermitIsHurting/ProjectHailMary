...
static const _RadarFrame_type_support_symbol_names_t _RadarFrame_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cuas_msgs, msg, RadarFrame)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cuas_msgs, msg, RadarFrame)),
  }
};
...
{
  return &::cuas_msgs::msg::rosidl_typesupport_cpp::RadarFrame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cuas_msgs, msg, RadarFrame)() {
  return get_message_type_support_handle<cuas_msgs::msg::RadarFrame>();
}
