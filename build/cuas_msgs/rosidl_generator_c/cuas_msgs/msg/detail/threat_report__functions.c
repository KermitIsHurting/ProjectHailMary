...
cuas_msgs__msg__ThreatReport__create()
{
  ...
  cuas_msgs__msg__ThreatReport * msg = (cuas_msgs__msg__ThreatReport *)allocator.allocate(sizeof(cuas_msgs__msg__ThreatReport), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(cuas_msgs__msg__ThreatReport));
  bool success = cuas_msgs__msg__ThreatReport__init(msg);
  if (!success) {
...
cuas_msgs__msg__ThreatReport__destroy(cuas_msgs__msg__ThreatReport * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    cuas_msgs__msg__ThreatReport__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
cuas_msgs__msg__ThreatReport__Sequence__init(cuas_msgs__msg__ThreatReport__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cuas_msgs__msg__ThreatReport * data = NULL;

  if (size) {
    data = (cuas_msgs__msg__ThreatReport *)allocator.zero_allocate(size, sizeof(cuas_msgs__msg__ThreatReport), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = cuas_msgs__msg__ThreatReport__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        cuas_msgs__msg__ThreatReport__fini(&data[i - 1]);
      }
...
cuas_msgs__msg__ThreatReport__Sequence__fini(cuas_msgs__msg__ThreatReport__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      cuas_msgs__msg__ThreatReport__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cuas_msgs__msg__ThreatReport__Sequence * array = (cuas_msgs__msg__ThreatReport__Sequence *)allocator.allocate(sizeof(cuas_msgs__msg__ThreatReport__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = cuas_msgs__msg__ThreatReport__Sequence__init(array, size);
  if (!success) {
...
cuas_msgs__msg__ThreatReport__Sequence__destroy(cuas_msgs__msg__ThreatReport__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    cuas_msgs__msg__ThreatReport__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
cuas_msgs__msg__ThreatReport__Sequence__are_equal(const cuas_msgs__msg__ThreatReport__Sequence * lhs, const cuas_msgs__msg__ThreatReport__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!cuas_msgs__msg__ThreatReport__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  cuas_msgs__msg__ThreatReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(cuas_msgs__msg__ThreatReport);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    cuas_msgs__msg__ThreatReport * data =
      (cuas_msgs__msg__ThreatReport *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cuas_msgs__msg__ThreatReport__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          cuas_msgs__msg__ThreatReport__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!cuas_msgs__msg__ThreatReport__copy(
